...
window.ITINERARY = {
  ...
  days: [
    ...
    },
    {
      ...
      summary: "Mañana en el Columbia Icefield: el Ice Explorer (el 'camión' glaciar) sobre el Athabasca Glacier. Por la tarde, el trek de Wilcox Pass (a 3 km, con la mejor vista frontal del glaciar) y regreso escénico por la Icefields Parkway hasta Banff. Día largo pero factible reservando el PRIMER turno del Ice Explorer.",
      drivingKm: 290, drivingTime: "≈4 h", hikingTime: "3–4 h", hikeName: "Wilcox Pass (tarde)",
      highlights: ["Ice Explorer sobre el Athabasca Glacier (el 'camión')", "Trek Wilcox Pass · vista frontal del glaciar", "Bow Lake · Peyto (2ª oportunidad)", "Praderas alpinas con bighorn"],
      alerts: ["🎫 Ice Explorer: reservar el PRIMER turno de la mañana (online, con antelación) para que quepa todo el día.", "⏳ Sí alcanza, pero es día largo: Icefield (mañana) + Wilcox (tarde) + 4 h de ruta → llegada a Banff al anochecer (~20:00). Hay luz de verano hasta ~21:00.", "⛽ Llenar en Jasper — tramo largo con poco servicio.", "🐏 Wilcox: praderas con bighorn; expuesto y ventoso arriba — no alimentar fauna.", "🍽️ Reservar/cenar tarde en Banff (verificar horario de cocina)."],
      schedule: [
        { time: "06:30", icon: "🚗", title: "Check-out y salida de Jasper", detail: "Rumbo sur por la Parkway (≈105 km al Icefield)." },
        { time: "08:15", icon: "🧊", title: "Llegada al Columbia Icefield", detail: "Estacionar la casa rodante en el Icefield Centre." },
        { time: "08:45", icon: "🚛", title: "Ice Explorer sobre el glaciar", detail: "El 'camión' glaciar sobre el Athabasca (reservar 1er turno); opcional Skywalk. ≈1,5–2 h." },
        { time: "11:00", icon: "🍽️", title: "Almuerzo en el Icefield Centre", detail: "Comer y repostar antes del trek." },
        { time: "12:00", icon: "🥾", title: "Trek Wilcox Pass", detail: "Trailhead a 3 km (Wilcox Creek) · 8 km · 3–4 h · vista frontal del glaciar." },
        { time: "15:45", icon: "🔙", title: "Fin del trek", detail: "" },
        { time: "16:00", icon: "🚗", title: "Ruta a Banff", detail: "≈290 km / 4 h; Bow Lake y Peyto (2ª oportunidad) en el camino." },
        { time: "20:00", icon: "🏨", title: "Llegada a Banff", detail: "Check-in al anochecer (con luz de verano)." },
        { time: "20:45", icon: "🍽️", title: "Cena tardía en Banff", detail: "Park Distillery o The Bison (verificar horario)." }
      ],
      food: {
      ...
      optimization: ["Reservar el Ice Explorer en el PRIMER turno (~08:45–09:00) para que quepa el trek de la tarde.", "Wilcox trailhead está a solo 3 km del Icefield Centre — cero traslado entre el 'camión' y el hike.", "En agosto hay luz hasta ~21:00: la llegada de noche a Banff no es problema.", "Buffer de +1 h por paradas fotográficas (Bow Lake, Peyto)."],
