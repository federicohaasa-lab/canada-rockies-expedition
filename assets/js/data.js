...
window.ITINERARY = {
  ...
  locations: [
    ...
    },
    {
      ...
      description: "Aguas turquesa bajo el glaciar Victoria y el Château Lake Louise. Se visita el Día 6 con el shuttle (junto a Moraine Lake). El estacionamiento se llena muy temprano — el shuttle es la mejor forma de acceder.",
      ...
      days: [6], popularity: 5, reservation: "Parking se satura: usar shuttle de Parks Canada (reservar)."
    },
    {
      id: "emerald_lake", name: "Emerald Lake", type: "lake", coords: [51.4429, -116.5289],
      img: "assets/img/photos/emerald_lake.jpg", credit: "Wikimedia Commons",
      short: "El lago verde esmeralda de Yoho.",
      description: "El lago más grande de Yoho National Park (BC), de un verde esmeralda intenso rodeado por el President Range. Un desvío corto desde la Trans-Canada (cerca de Field). Sendero llano de ≈5 km alrededor del lago y canoas junto a un lodge histórico.",
      duration: "1–1,5 h", difficulty: "Fácil", bestTime: "Media mañana / tarde (verde intenso con sol)",
      photoTips: "Puente de troncos hacia el lodge; canoa roja en primer plano; vuelta al lago para el reflejo sin viento.",
      days: [1], popularity: 5, reservation: "No requiere. Estacionamiento pequeño — llegar temprano o media tarde."
    },
    {
    ...
    },
    {
      ...
      days: [5], popularity: 5, reservation: "Ice Explorer / Skywalk: reserva recomendada online."
    },
    {
    ...
    },
    {
      ...
      duration: "5–7 h · ≈10–12 km · +490 m", difficulty: "Moderado", bestTime: "Mañana (tormentas por la tarde)",
  ...
  days: [
    ...
    },
    {
      ...
      route: "Calgary · Banff · Emerald Lake (Yoho) · Peyto Lake · Athabasca Falls · Jasper · Mount Robson",
      routeStops: ["calgary", "banff_town", "emerald_lake", "peyto_lake", "athabasca_falls", "jasper_town", "mount_robson"],
      badge: "Salida tarde · ruta escénica",
      ...
      summary: "Salida al mediodía (~12:00) de Calgary con parada en el verde Emerald Lake (Yoho) y ruta escénica por la Icefields Parkway hasta dormir a los pies del Mount Robson. Con el arranque tarde, la llegada a Robson es al anochecer — Peyto y Athabasca Falls quedan como paradas rápidas (se ven con calma el Día 11 de vuelta).",
      drivingKm: 520, drivingTime: "≈7 h", hikingTime: "Paseos cortos", hikeName: "Miradores en ruta",
      highlights: ["Emerald Lake (Yoho) verde esmeralda", "Peyto Lake (cabeza de lobo)", "Athabasca Falls", "Primer avistaje del Mount Robson (3.954 m)"],
      alerts: ["⏰ Salida ~12:00 de Calgary → llegada a Robson al anochecer (~21:00). Para llegar antes: saltar Peyto/Athabasca (se ven el Día 11).", "⛽ COMBUSTIBLE: llenar en Lake Louise y de nuevo en Jasper — última antes de Mount Robson.", "🕐 Cambio de hora al entrar a BC: Mount Robson usa hora del Pacífico (−1 h).", "📵 Sin cobertura en casi toda la ruta. 🎫 Parks Canada Pass a la vista."],
      schedule: [
        { time: "12:00", icon: "🚗", title: "Salida de Calgary", detail: "Arranque al mediodía; rumbo oeste por la Trans-Canada (Hwy 1)." },
        { time: "13:30", icon: "☕", title: "Parada rápida en Banff / Canmore", detail: "Café y estirar las piernas." },
        { time: "15:00", icon: "💚", title: "Emerald Lake (Yoho)", detail: "Desvío corto cerca de Field; verde esmeralda, canoas y vuelta al lago (≈1 h)." },
        { time: "17:00", icon: "📸", title: "Peyto Lake (rápido)", detail: "Mirador de Bow Summit; parada breve (o saltar y verlo el Día 11)." },
        { time: "19:15", icon: "💦", title: "Athabasca Falls (rápido)", detail: "Pasarelas sobre el cañón (o saltar y verlo el Día 11)." },
        { time: "20:00", icon: "⛽", title: "Jasper — repostar", detail: "Última gasolinera y compras antes de Robson." },
        { time: "21:15", icon: "🏔️", title: "Llegada a Mount Robson", detail: "Check-in al anochecer; cena en la casa rodante." }
      ],
      food: {
      ...
      optimization: ["Con salida al mediodía, priorizar Emerald Lake y no demorarse: cada parada retrasa la llegada a Robson.", "Peyto y Athabasca Falls son opcionales hoy — se recorren de nuevo el Día 11 de vuelta a Banff.", "Llenar estanque en Lake Louise y Jasper (crítico).", "Recordar el cambio a hora del Pacífico al entrar a BC."],
      routeCoords: [[51.0447, -114.0719], [51.1784, -115.5708], [51.4429, -116.5289], [51.7161, -116.5261], [52.6642, -117.8850], [52.8737, -118.0814], [53.0353, -119.2360]],
    ...
    },
    {
      ...
      drivingKm: 96, drivingTime: "≈2 h", hikingTime: "5–7 h", hikeName: "Bald Hills (recomendado)",
      alternatives: { title: "Alternativas de hike en Jasper · estado ago 2026", recommended: "Bald Hills", note: "Los 2 días de Jasper (9 y 10 ago) son flexibles: elige según energía y clima. Verificar cierres en Parks Canada el día antes — siguen levantando restricciones puntuales.", items: [
        { name: "Bald Hills", dist: "10–12 km", hours: "5–7 h", diff: "Moderado", status: "Abierto" },
        { name: "Sulphur Skyline", dist: "9 km", hours: "4–5 h", diff: "Exigente", status: "Abierto" },
        { name: "Skyline (tramo)", dist: "~14 km", hours: "6 h", diff: "Moderado", status: "Abierto" },
        { name: "Opal Hills", dist: "8 km", hours: "3–4 h", diff: "Exigente", status: "Abierto" },
        { name: "Valley of Five Lakes", dist: "4,5 km", hours: "1,5 h", diff: "Fácil", status: "Reabierto" },
        { name: "Cavell Meadows", dist: "—", hours: "—", diff: "—", status: "Cerrado" },
        { name: "Maligne Canyon", dist: "—", hours: "—", diff: "—", status: "Cerrado" }
      ] },
      highlights: ["Panorámica 360° desde Bald Hills", "Spirit Island (crucero)", "Fauna en Maligne Road", "Medicine Lake"],
      alerts: ["🦌 Maligne Road: fauna abundante (caribú, alce, oso). Conducir despacio al amanecer/atardecer.", "⛵ Crucero a Spirit Island: reservar con antelación.", "🚧 Cerrados en 2026: Cavell Meadows y Maligne Canyon — verificar estado en Parks Canada el día antes.", "🐻 Temporada de bayas: osos activos — bear spray siempre."],
      schedule: [
    ...
    {
      n: 4, date: "10 Ago", dow: "Domingo", title: "Jasper — día flexible · favorito Valley of Five Lakes", base: "Jasper",
      route: "Jasper · Valley of Five Lakes · alternativas (Sulphur Skyline · Miette…)",
      ...
      summary: "Día flexible en Jasper. Vuestra elección probable ⭐: Valley of Five Lakes (corto y suave, cinco lagos turquesa). Alternativa de mayor esfuerzo/recompensa: Sulphur Skyline + Miette Hot Springs. Noche ideal de Cielo Oscuro (Vía Láctea).",
      drivingKm: 60, drivingTime: "≈1,5 h", hikingTime: "1,5–5 h (según elección)", hikeName: "Valley of Five Lakes (favorito)",
      alternatives: { title: "Alternativas de hike en Jasper · estado ago 2026", recommended: "Valley of Five Lakes", note: "Los 2 días de Jasper (9 y 10 ago) son flexibles: elige según energía y clima. ⭐ = vuestro favorito probable. Verificar cierres en Parks Canada el día antes — siguen levantando restricciones puntuales.", items: [
        { name: "Bald Hills", dist: "10–12 km", hours: "5–7 h", diff: "Moderado", status: "Abierto" },
        { name: "Sulphur Skyline", dist: "9 km", hours: "4–5 h", diff: "Exigente", status: "Abierto" },
        { name: "Skyline (tramo)", dist: "~14 km", hours: "6 h", diff: "Moderado", status: "Abierto" },
        { name: "Opal Hills", dist: "8 km", hours: "3–4 h", diff: "Exigente", status: "Abierto" },
      ...
      highlights: ["⭐ Valley of Five Lakes (4,5 km · fácil)", "Alt: Sulphur Skyline (9 km · exigente) + Miette Hot Springs", "Pyramid Lake al amanecer", "Cielo oscuro — Vía Láctea"],
      alerts: ["🐻 Temporada de bayas (agosto): osos activos — bear spray en todos los senderos.", "🚧 CERRADOS en 2026: Cavell Meadows y Maligne Canyon — verificar cierres en Parks Canada el día antes.", "🌡️ Miette Hot Springs cierra temprano — verificar horario.", "🎫 Reservar con antelación cualquier actividad."],
      schedule: [
        { time: "08:00", icon: "☕", title: "Desayuno sin prisa", detail: "Bear's Paw Bakery." },
        { time: "09:30", icon: "🏞️", title: "Valley of Five Lakes ⭐ (favorito)", detail: "4,5 km · fácil · 1,5 h; cinco lagos de distinto turquesa." },
        { time: "11:30", icon: "🥾", title: "Opción de mayor esfuerzo", detail: "Sulphur Skyline (9 km · exigente · 4–5 h) si quieren un gran hike." },
        { time: "13:30", icon: "♨️", title: "Miette Hot Springs", detail: "Relax en las aguas termales más calientes de las Rocosas." },
        { time: "17:30", icon: "📸", title: "Pyramid Lake / Patricia Lake", detail: "Atardecer y reflejos." },
    ...
    {
      n: 5, date: "11 Ago", dow: "Lunes", title: "Jasper → Banff · Columbia Icefield + Wilcox Pass", base: "Banff",
      route: "Jasper · Columbia Icefield (Ice Explorer) · Wilcox Pass · Icefields Parkway · Banff",
